...
import { Award, MessageSquare, Users, Zap, Star, Gamepad2, Eye, MapPin, Trophy, HelpCircle, Lock, Sparkles, Brain, MessageCircleHeart, UserCheck, Filter, TrendingUp, Settings } from 'lucide-react';
                                ...
                                <>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      {t(feature.unlockDetailsKey, {
                                          points: feature.unlockConditionKey === 'pointsNeeded' ? feature.unlockValue : undefined,
                                          badgeName: feature.unlockConditionKey === 'badgeNeeded' ? t(`badge_${feature.unlockValue}_name`) : undefined
                                      })}
                                    </p>
                             ...
                             <Button
                                 ...
                                 onClick={() => {
                                     if (feature.ctaLink && !feature.isLocked) {
                                        ...
                                        toast({ title: t('featureLockedTitle'), description: t(feature.unlockDetailsKey, {
                                            points: feature.unlockConditionKey === 'pointsNeeded' ? feature.unlockValue : undefined,
                                            badgeName: feature.unlockConditionKey === 'badgeNeeded' ? t(`badge_${feature.unlockValue}_name`) : undefined
                                        })});
                                     } else {
