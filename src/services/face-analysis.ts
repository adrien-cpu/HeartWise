...
// Note: The previous 'analyzeFaces' function sorting by random similarity was removed
// as 'compareFaces' provides a more direct simulation of pairwise comparison.
